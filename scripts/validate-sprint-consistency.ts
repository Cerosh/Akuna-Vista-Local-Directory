 ...
 *
 * Sprint 16 F-006, Check 3. For every sprints/sprint- (wildcard) folder, if every
 * row in README.md's Features table is the exact plain word "Completed",
 * tasks.md for that same sprint must have zero remaining `- [ ]` lines.
 * Traces back to Sprint 09, where README.md was accurate but tasks.md had
 * ~40 stale unchecked boxes nobody had gone back to flip. Doesn't need a
 * diff — runs against the current repo state, same as validate:data.
 */
