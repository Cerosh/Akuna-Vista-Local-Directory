...
This document defines the quality strategy for the Neighbourhood Directory Platform.
...
Business Details + Recommendations
...
shouldDisplayFeaturedBusinesses()

shouldFilterBusinessesByCategory()

shouldOpenBusinessDetails()
