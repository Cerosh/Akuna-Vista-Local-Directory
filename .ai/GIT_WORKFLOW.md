...
This document defines the Git workflow for the Neighbourhood Directory Platform.
...
feat(directory): add business category filtering
...
refactor(repository): simplify JSON access
